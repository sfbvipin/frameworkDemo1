...
public class genericFunctions extends AllVariables {
	...
	public void user_click_sign_after_budget_billing() throws InterruptedException {
		driver.findElement(By.xpath(signinafterbudgetbilling)).click();
		Thread.sleep(3000);
	}
	@Then ("user click move service after thanks")
	public void user_click_move_service_after_thanks() throws InterruptedException {
		driver.findElement(By.xpath(moveServicefromnothanks)).click();
		Thread.sleep(3000);
	}
	...
	{
		driver.findElement(By.xpath(signinfromchatbot)).click();
		Thread.sleep(5000);
	}
	...
	public void select_and_click_on_downed_power_lines() throws InterruptedException {
		WebElement downedpowerlne=driver.findElement(By.xpath(downedpowerlinesfrommenu));
		Thread.sleep(4000);
		
		downedpowerlne.click();
	...
	public void user_will_type_stop_service() throws InterruptedException {
		driver.findElement(By.xpath(accounttype)).sendKeys("Stop Service");
		Thread.sleep(2000);
		driver.findElement(By.xpath(sendbutton)).click();
		Thread.sleep(2000);
	}
	...
	public void click_on_the_link_in_the_stop_service_content() throws InterruptedException{
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,-250)", "");
		driver.findElement(By.xpath(stopServiceLink)).click();
		Thread.sleep(2000);
	}
