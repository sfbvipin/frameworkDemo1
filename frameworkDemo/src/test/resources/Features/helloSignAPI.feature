...
Feature: Feature to test Hello Sign API cases
  ...
  @Basic @API @HelloSIgn @TC_HCM_001
  ...
  @Basic @API @HelloSIgn @TC_HCM_002
  ...
  @Basic @API @HelloSIgn @TC_HCM_005
